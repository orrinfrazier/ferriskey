use crate::application::http::{
    abyss::AbyssApiDoc, authentication::router::AuthenticationApiDoc, broker::BrokerApiDoc,
    client::router::ClientApiDoc, realm::router::RealmApiDoc, role::router::RoleApiDoc,
